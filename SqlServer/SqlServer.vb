Public Class SQLServer
    ...
    ''' <remarks></remarks>
    Public Overloads Overrides Sub CargarParametros(ByVal Com As System.Data.IDbCommand, ByVal Args As Object())
    ...
    ''' <param name="Args"></param>
    ''' <remarks></remarks>
    Public Overloads Overrides Sub CargarParametros(ByVal Com As System.Data.IDbCommand, ByVal Parametros() As String, ByVal Args As Object())
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function Comando(ByVal ProcedimientoAlmacenado As String) As System.Data.IDbCommand
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function ComandoConsulta(ByVal Consulta As String) As System.Data.IDbCommand
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function CrearConexion(ByVal CadenaConexion As String) As System.Data.IDbConnection
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function CrearDataAdapter(ByVal ProcedimientoAlmacenado As String, ByVal ParamArray Args As Object()) As System.Data.IDataAdapter
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function CrearDataAdapterConsulta(ByVal Consulta As String) As System.Data.IDataAdapter
    ...
    ''' <returns></returns>
    ''' <remarks></remarks>
    Public Overloads Overrides Function CrearDataAdapter(ByVal ProcedimientoAlmacenado As String, ByVal Parametros() As String, ByVal ParamArray Args As Object()) As System.Data.IDataAdapter
        Dim Da As New System.Data.SqlClient.SqlDataAdapter(DirectCast(Comando(ProcedimientoAlmacenado), System.Data.SqlClient.SqlCommand))
        Da.SelectCommand.CommandTimeout = 200
        If Args.Length <> 0 Then
